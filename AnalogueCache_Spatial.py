...
residual = False
method='Corr'  # Overwrite the "spatial correlation" with RMSE instead
...
if 'ciclad' in myhost:
    ...
    hadisst_save_file_residual = '/home/users/mmenary/data/HadISST_AnnualMapCMIPStyleRegridded_Residual.pkl'
    en4_save_file = '/home/users/mmenary/data/EN4_0-500m_AnnualMapCMIPStyleRegridded.pkl'
    en4_save_file_residual = '/home/users/mmenary/data/EN4_0-500m_AnnualMapCMIPStyleRegridded_Residual.pkl'  # Not made yet
...
if os.path.isfile(this_file):
    with open(this_file, 'rb') as handle:
        sst_in, sst_ts_in, area_in, lon_in, lat_in, year_model_in = pickle.load(handle)
